...
with fileinput.FileInput(relax_folder + "Old_Relaxations_for_Samuli.py", inplace=True) as file:
	for line in file:
...
fig, axs = plt.subplots(1, 3, figsize=(15, 6))
axs[0].plot(existing_res_avg, combined_list_average[0], label='R1 Data', marker='o', linestyle='-', lw=1.0, markersize=2, color="blue")
axs[0].set_xlabel('Residue number')
axs[0].set_ylabel('R1_values')
axs[0].set_title('R1_data')
axs[0].legend()
axs[1].plot(existing_res_avg, combined_list_average[1], label='R2 Data', marker='o', linestyle='-', lw=1.0, markersize=2, color="blue")
axs[1].set_xlabel('Residue number')
axs[1].set_ylabel('R2_values')
axs[1].set_title('R2_data')
axs[1].legend()
axs[2].plot(existing_res_avg, combined_list_average[2], label='NOE Data', marker='o', linestyle='-', lw=1.0, markersize=2, color="blue")
axs[2].set_xlabel('Residue number')
axs[2].set_ylabel('NOE_values')
axs[2].set_title('NOE_data')
axs[2].legend()

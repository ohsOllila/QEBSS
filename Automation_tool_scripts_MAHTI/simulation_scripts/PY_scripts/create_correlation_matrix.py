...
fig, axs = plt.subplots(20, 5, figsize=(7, 28))
	...
	for i, model in enumerate(models):
		for j, forcefield in enumerate(forcefields):
			try:
				...
				new_xlim = (current_xlim[0]-current_xlim[1]*0.1, current_xlim[1]*1.1)
				new_ylim = (current_ylim[0]-current_ylim[1]*0.1, current_ylim[1]*1.1)
